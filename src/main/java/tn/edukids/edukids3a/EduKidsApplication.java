...
public class EduKidsApplication extends Application {
    ...
    public void init() {
        try {
            // Initialiser la base de donnees (creer si necessaire)
    ...
    public void start(Stage stage) throws IOException {
        if (persistenceBootstrapError != null) {
            ...
            a.setTitle("EduKids");
            a.setHeaderText("Impossible d'ouvrir la base de donnees");
            a.setContentText(
                    "Verifiez que MySQL est demarre et que la base configuree existe (par defaut : edukids sur localhost:3308).\n\n"
